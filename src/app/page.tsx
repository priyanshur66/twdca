...
const FeatureCard = ({ icon, title, description, delay = 0 }) => {
  ...
  return (
    <div className={`bg-slate-400/10 backdrop-blur-sm rounded-2xl p-6 border border-slate-800/20 hover:border-slate-600/20 transition-all duration-500 transform ${
      isVisible 
        ? 'translate-y-0 opacity-100 scale-100' 
        : 'translate-y-8 opacity-0 scale-95'
    } hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20`}>
      <div className="text-4xl mb-4 text-center">{icon}</div>
      <h3 className="text-xl font-semibold text-black mb-2 text-center">{title}</h3>
      ...
      <div className="min-h-screen bg-black grid p-2 grid-cols-12 items-center justify-start pt-20">
        <div className="min-h-screen lg:col-span-6 bg-black text-white flex flex-col items-center justify-center p-8 pt-0">
          <div className="text-left max-w-4xl">
            ...
            <div className="flex items-center justify-left gap-6 text-6xl md:text-8xl font-light">
              <svg viewBox="0 0 243 57" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-60 h-auto">
        ...
        <div className="lg:col-span-6 px-10 w-full max-w-166 mx-auto rounded-2xl">
          <div className={`bg-[url('/bg.png')] backdrop-blur-sm flex transition-all  bg-card flex-col items-center justify-center gap-2 p-4 rounded-2xl group bg-cover bg-center bg-no-repeat border border-gray-800 shadow-xl transform ${
            cardVisible 
              ? 'translate-y-0 opacity-100 scale-100' 
              : 'translate-y-8 opacity-0 scale-95'
 ...
 <div className="bg-black py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FloatingElement delay={1000}>
            <ConnectWallet className="text-xl px-12 py-4 bg-white text-blue-600 hover:bg-gray-100 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 mx-auto" />
          </FloatingElement>
        </div>
      </div>
      ...
      <footer className="bg-gray-950 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex text-center  gap-8">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">TWDCA</h3>
            </div>
              <p className="text-gray-400">
                The future of automated copy trading powered on Aptos blockchain.
              </p>
