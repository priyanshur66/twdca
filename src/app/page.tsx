...
const StepCard = ({
  ...
  return (
    <div className="bg-gray-950/40 rounded-2xl p-4 mb-3 text-white border border-gray-700 hover:border-gray-600 transition-all duration-300">
    ...
    <>
      ...
      <div className="min-h-screen bg-black grid p-2 grid-cols-12 items-center justify-start pt-20">
        ...
        <div className="lg:col-span-6 px-10 w-full max-w-166 mx-auto rounded-2xl">
          <div className="bg-[url('/bg.png')] flex transition-all bg-card flex-col items-center justify-center gap-2 p-4 rounded-2xl group bg-cover bg-center bg-no-repeat border border-gray-900 shadow-xl">
